    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
          {/* Left side - Images */}
          <div className="flex flex-col justify-center lg:justify-center items-center h-auto w-full">
            <div className="rounded-lg overflow-hidden w-[500px] h-[400px]">
              <img 
          ...
          <div className="flex flex-col justify-center">
            ...
            <Link 
              to="/about"
              className="inline-flex items-center justify-center px-6 py-3 mt-8 bg-navylight text-background font-medium rounded-lg hover:bg-aqua hover:text-primary transition-colors w-fit"
            >
              Read More...
            </Link>
          </div>
