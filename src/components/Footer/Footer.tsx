...
export default function Footer() {
  return (
    <>
      <footer className="bg-navylight text-aqua py-12">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-12 gap-8">
          {/* Company Info Section */}
          <div className="md:col-span-3 section-fade">
            <h3 className="text-xl font-serif font-bold mb-4 text-white">Raiyan Global</h3>
          ...
          <div className="md:col-span-3 section-fade" style={{ animationDelay: '0.2s' }}>
            <h3 className="text-xl font-serif font-bold mb-4 text-background">About Us</h3>
          ...
          <div className="md:col-span-2 section-fade" style={{ animationDelay: '0.4s' }}>
            <h3 className="text-xl font-serif font-bold mb-4 text-white">Quick Links</h3>
            <div className="space-y-2">
              <div>
          ...
          <div className="md:col-span-4 section-fade" style={{ animationDelay: '0.6s' }}>
            <h3 className="text-xl font-serif font-bold mb-4 text-white">Location</h3>
      ...
      {/* Copyright Section */}
      <div className="bg-navy/90 py-4 text-aqua border-t border-aqua/10">
